  ...
  return [
    {
      ...
      menus: [
        {
          id: "dashboard",
          href: "/dashcode/dashboard/analytics",
          label: t("dashboard"),
          active: pathname.includes("/dashcode/dashboard"),
          icon: "heroicons-outline:home",
          submenus: [
            {
              href: "/dashcode/dashboard/analytics",
              label: t("analytics"),
              active: pathname === "/dashcode/dashboard/analytics",
              icon: "heroicons:arrow-trending-up",
              children: [],
            },
            {
              href: "/dashcode/dashboard/dash-ecom",
              label: t("ecommerce"),
              active: pathname === "/dashcode/dashboard/dash-ecom",
              icon: "heroicons:shopping-cart",
              children: [],
            },
            {
              href: "/dashcode/dashboard/project",
              label: t("project"),
              active: pathname === "/dashcode/dashboard/project",
              icon: "heroicons:document",
              children: [],
            },
            {
              href: "/dashcode/dashboard/crm",
              label: t("crm"),
              active: pathname === "/dashcode/dashboard/crm",
              icon: "heroicons:share",
              children: [],
            },
            {
              href: "/dashcode/dashboard/banking",
              label: t("banking"),
              active: pathname === "/dashcode/dashboard/banking",
    ...
    },
    {
      ...
      menus: [
        {
          id: "changelog",
          href: "/dashcode/changelog",
          label: t("changelog"),
          active: pathname.includes("/dashcode/changelog"),
          icon: "heroicons:arrow-trending-up",
          submenus: [],
        },
      ],
      ...
      menus: [
        {
          ...
          label: t("chat"),
          active: pathname.includes("/dashcode/app/chat"),
        ...
        },
        {
          ...
          label: t("email"),
          active: pathname.includes("/dashcode/app/email"),
          icon: "heroicons-outline:mail",
          submenus: [],
        },
        {
          id: "kanban",
          href: "/dashcode/app/kanban",
          label: t("kanban"),
          active: pathname.includes("/dashcode/app/kanban"),
        ...
        },
        {
          ...
          label: t("calendar"),
          active:pathname.includes("/dashcode/app/calendar"),
          icon: "heroicons-outline:calendar",
          submenus: [],
        },
        {
          id: "todo",
          href: "/dashcode/app/todo",
          label: t("todo"),
          active:pathname.includes("/dashcode/app/todo"),
          icon: "heroicons-outline:clipboard-check",
          submenus: [],
        },
        {
          id: "projects",
          href: "/dashcode/app/projects",
          label: t("projects"),
          active: pathname.includes("/dashcode/app/projects"),
    ...
    },
    {
      ...
      menus: [
        {
          id: "ecommerce",
          href: "/dashcode/ecommerce/frontend",
          label: t("ecommerce"),
          active: pathname.includes("/dashcode/ecommerce"),
          icon: "heroicons-outline:shopping-bag",
          submenus: [
            {
              href: "/dashcode/ecommerce/frontend",
              label: t("userApp"),
              active: pathname.includes("/dashcode/ecommerce/frontend"),
              icon: "heroicons-outline:user",
              children: [
                {
                  href: "/dashcode/ecommerce/frontend",
                  label: t("products"),
                  active: pathname === "/dashcode/ecommerce/frontend",
                },
                {
                  href: "/dashcode/ecommerce/frontend/c06d48bf-7f35-4789-b71e-d80fee5b430t",
                  label: t("productDetails"),
                  active:
                    pathname ===
                    "/dashcode/ecommerce/frontend/c06d48bf-7f35-4789-b71e-d80fee5b430t",
                },
                {
                  href: "/dashcode/ecommerce/frontend/checkout/cart",
                  label: t("cart"),
                  active: pathname === "/dashcode/ecommerce/frontend/checkout/cart",
                },
                {
                  href: "/dashcode/ecommerce/frontend/wishlist",
                  label: t("wishlist"),
                  active: pathname === "/dashcode/ecommerce/frontend/wishlist",
                },
              ],
            },
            {
              href: "/dashcode/ecommerce/backend",
              label: t("adminApp"),
              active: pathname.includes("/dashcode/ecommerce/backend"),
              icon: "heroicons-outline:user-circle",
              children: [
                {
                  href: "/dashcode/ecommerce/backend/add-product",
                  label: t("addProduct"),
                  active: pathname === "/dashcode/ecommerce/backend/add-product",
                },
                {
                  href: "/dashcode/ecommerce/backend/customer-list",
                  label: t("customerList"),
                  active: pathname === "/dashcode/ecommerce/backend/customer-list",
                },
                {
                  href: "/dashcode/ecommerce/backend/edit-product",
                  label: t("editProduct"),
                  active: pathname === "/dashcode/ecommerce/backend/edit-product",
                },
                {
                  href: "/dashcode/ecommerce/backend/invoice",
                  label: t("invoice"),
                  active: pathname === "/dashcode/ecommerce/backend/invoice",
                },
                {
                  href: "/dashcode/ecommerce/backend/order-details",
                  label: t("orderDetails"),
                  active: pathname === "/dashcode/ecommerce/backend/order-details",
                },
                {
                  href: "/dashcode/ecommerce/backend/order-list",
                  label: t("orderList"),
                  active: pathname === "/dashcode/ecommerce/backend/order-list",
                },
                {
                  href: "/dashcode/ecommerce/backend/purchase-list",
                  label: t("purchaseList"),
                  active: pathname === "/dashcode/ecommerce/backend/purchase-list",
                },
                {
                  href: "/dashcode/ecommerce/backend/sellers",
                  label: t("sellers"),
                  active: pathname === "/dashcode/ecommerce/backend/sellers",
                },
              ],
            },
          ],
          ...
          submenus: [
            {
              href: "/dashcode/app/chat",
              label: t("chat"),
              active: pathname === "/dashcode/app/chat",
              icon: "heroicons-outline:chat",
              children: [],
            },
            {
              href: "/dashcode/app/email",
              label: t("email"),
              active: pathname === "/dashcode/app/email",
              icon: "heroicons-outline:mail",
              children: [],
            },
            {
              href: "/dashcode/app/kanban",
              label: t("kanban"),
              active: pathname === "/dashcode/app/kanban",
              icon: "heroicons-outline:view-boards",
              children: [],
            },
            {
              href: "/dashcode/app/calendar",
              label: t("calendar"),
              active: pathname === "/dashcode/app/calendar",
              icon: "heroicons-outline:calendar",
              children: [],
            },
            {
              href: "/dashcode/app/todo",
              label: t("todo"),
              active: pathname === "/dashcode/app/todo",
              icon: "heroicons-outline:clipboard-check",
              children: [],
            },
            {
              href: "/dashcode/app/projects",
              label: t("projects"),
              active: pathname === "/dashcode/app/projects",
              icon: "heroicons-outline:document",
              children: [],
            },
          ],
      ...
      menus: [
        {
          ...
          submenus: [
            ...
            },
            {
              href: "/dashcode/ecommerce/backend",
              label: t("adminApp"),
              active: pathname === "/dashcode/ecommerce/backend",
              icon: "heroicons-outline:user-circle",
              children: [
                {
                  href: "/dashcode/ecommerce/backend/add-product",
