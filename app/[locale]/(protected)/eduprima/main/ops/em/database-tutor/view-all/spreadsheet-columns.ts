...
export const SPREADSHEET_COLUMNS: Column[] = [
  ...
  { key: 'registration_current_status', label: 'Registration Status', width: 140, type: 'select', category: 'System & Management' },
  { key: 'operations_current_status', label: 'Operations Status', width: 140, type: 'select', category: 'System & Management' },
