      ...
      <div className="flex flex-wrap gap-2 md:mt-16 md:pb-14">
        <div className="flex-1">
          <Button asChild variant="outline">
                            <Link href="/dashcode/ecommerce/frontend">
        ...
        <div className="flex-none">
          <Button asChild disabled>
                            <Link href="/dashcode/ecommerce/frontend/checkout/delivery-info">
              Go Back
            </Link>
          </Button>
        </div>
        <div className="flex-none">
          <Button asChild>
                            <Link href="/dashcode/ecommerce/frontend/checkout/confirmation">Submit</Link>
          </Button>
        </div>
      </div>
    </div>
